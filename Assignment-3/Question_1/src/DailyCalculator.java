...
public class DailyCalculator {
			...
			public DailyCalculator(int milesperday, double costpergallon, double average, int parkingfees,
					int tollsperday, int noofpassenger) {
			...
			void acceptdata() {
				Scanner sc = new Scanner(System.in);
			     ...
			     System.out.println("Enter the no of passenger that will travel with you");	 
			...
			void displaydata() {
				 System.out.print("The Miles you drive per day is: "+ milesperday);
				 System.out.print("The Cost per gallon fuel is : "+ costpergallon );
				 System.out.print("The Average of your vehical is : " + Average);
				 System.out.println("The Parking fess for your vehical will be: " + parkingfees);
				
				 System.out.print("Your tolls per day are : "+ tollsperday);
				 System.out.println("No of passenger traveling with you are: "+ noofpassenger);
				 
			}
				 void Calculations() {
					 double totexp = (milesperday/Average)*costpergallon;
